        ...
        <table class="table">
            ...
            <tbody class="center">
                <tr>
                    ...
                    <td><input type="text" name="host" placeholder="Host"></td>
                </tr>

                <tr>
                    <td><font color="black" size="3"><b>Usuario DB:</b></font></td>
                    <td><input type="text" name="user" placeholder="Usuario DB"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="db" placeholder="Base de datos"></td>
                </tr>
